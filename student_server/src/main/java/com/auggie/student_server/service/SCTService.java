...
import com.auggie.student_server.entity.SCTInfo1;
...
public class SCTService {
    ...
    public List<SCTInfo1> findBySearch1(Map<String, String> map) {
        Integer sid = null, cid = null, tid = null;
        String sname = null, cname = null, tname = null, term = null;
        Integer sFuzzy = null, cFuzzy = null, tFuzzy = null,count=null;
        Integer lowBound = null, highBound = null;
        ...
        if (map.containsKey("count")) {
            try {
                tid = Integer.parseInt(map.get("count"));
            }
            catch (Exception e) {
            }
        }
        ...
        List<SCTInfo1> list2=studentCourseTeacherMapper.findBySearch2(sid,tid,term);
